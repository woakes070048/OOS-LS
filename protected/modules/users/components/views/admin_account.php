...
<div class="account">
	<?php //begin.Photo ?>
	<a off_address="" id="uplaod-image" class="photo" href="<?php echo Yii::app()->createUrl('users/photo/ajaxadd', array('type'=>'admin'));?>" title="<?php echo Phrase::trans(16223,1).': '.Yii::app()->user->displayname;?>"><img src="<?php echo $images;?>" alt="<?php echo Yii::app()->user->photo != '' ? Yii::app()->user->displayname : 'Ommu Platform';?>"/></a>
	<div class="info">
